...
void ProgressBar_DisplayProgress(char *msg, char *src, u32 offset, u32 size) {
	...
	oslDrawString(((480 - (text_width)) / 2), ((272 - oslGetImageHeight(dialog)) / 2) + 30, src_resized);

	OSL_DrawFillRect(((480 - oslGetImageWidth(dialog)) / 2) + 20, ((272 - oslGetImageHeight(dialog)) / 2) + 60, 
